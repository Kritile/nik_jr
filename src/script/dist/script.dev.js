...
document.querySelector('.switch .mout').addEventListener('click', function () {
...
document.querySelector('.switch .ann').addEventListener('click', function () {
...
document.querySelector('.images__wrapper .prev').addEventListener('click', function () {
  if (!document.querySelector('.image.active').previousElementSibling.classList.contains('image')) {
    var el = document.querySelector('.image.active .name');
    ...
    var element = document.querySelector('.image.active');
...
document.querySelector('.images__wrapper .next').addEventListener('click', function () {
  if (!document.querySelector('.image.active').nextElementSibling.classList.contains('image')) {
    ...
    document.querySelector('.image.active').classList.remove('active');
    var el = document.querySelectorAll('.images__wrapper .image')[0];
    el.classList.add('active');
  } else {
    var _el = document.querySelector('.image.active');

    if (_el.previousElementSibling.classList.contains('image')) {
      document.querySelector('.images__wrapper .prev .name').innerText = _el.querySelector('.name').innerText;
...
document.querySelector('.comp .prev').addEventListener('click', function () {
  var active = document.querySelector('.comp_list.active');
...
document.querySelector('.comp .next').addEventListener('click', function () {
  var active = document.querySelector('.comp_list.active');
